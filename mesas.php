...
$nrRegistrosPagina = 3;
$sql = mysql_query("Select * FROM produto  where id_categoria ='3' limit ".($pagina*$nrRegistrosPagina-$nrRegistrosPagina).",$nrRegistrosPagina");
...
echo "<a href='mesas.php?pagina=$i'><button class=''>$i</button></a> ";
}
