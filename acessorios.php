...
$nrRegistrosPagina = 3;
$sql = mysql_query("Select * FROM produto  where id_categoria ='8' limit ".($pagina*$nrRegistrosPagina-$nrRegistrosPagina).",$nrRegistrosPagina");
...
echo "<a href='acessorios.php?pagina=$i'><button class=''>$i</button></a> ";
}
