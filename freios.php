...
$nrRegistrosPagina = 3;
$sql = mysql_query("Select * FROM produto  where id_categoria ='4' limit ".($pagina*$nrRegistrosPagina-$nrRegistrosPagina).",$nrRegistrosPagina");
...
echo "<a href='freios.php?pagina=$i'><button class=''>$i</button></a> ";
}
