...
$nrRegistrosPagina = 3;
$sql = mysql_query("Select * FROM produto  where id_categoria ='5' limit ".($pagina*$nrRegistrosPagina-$nrRegistrosPagina).",$nrRegistrosPagina");
...
echo "<a href='aros.php?pagina=$i'><button class=''>$i</button></a> ";
}
