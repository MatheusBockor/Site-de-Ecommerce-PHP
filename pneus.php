...
$nrRegistrosPagina = 3;
$sql = mysql_query("Select * FROM produto  where id_categoria ='6' limit ".($pagina*$nrRegistrosPagina-$nrRegistrosPagina).",$nrRegistrosPagina");
...
echo "<a href='pneus.php?pagina=$i'><button class=''>$i</button></a> ";
}
